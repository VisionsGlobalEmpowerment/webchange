...
- [Components](create_content/components/index.md)
  - [Existing components](create_content/components/existing-components.md)
  - [Create component](create_content/components/create-component.md)
- [Actions](create_content/actions/index.md)
  - [Create action](create_content/actions/create-action.md)
- [Guide](create_content/complete_guide/index.md)
  - [Component](create_content/complete_guide/component.md)
  - [Action](create_content/complete_guide/action.md)
