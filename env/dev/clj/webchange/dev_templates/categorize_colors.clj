...
(comment
  ...
  (core/save-scene! test-course-slug scene-slug saved-data-2 t/user-id)
  ...
  {:assets        [{:url "/raw/img/categorize/01.png", :size 10, :type "image"}
   ...
   :actions       {:green-color-r1                                    {:data               [{:data [{:type "empty", :duration 0}
                   ...
                   :question-1-options-option-3-substrate-inactivate  {:id     "default",
                                                                       :tags   ["inactivate-options-question-1-question-id"
                                                                                "inactivate-option-option-3-question-1-question-id"],
                                                                       :type   "state",
                   ...
                   :question-0-task-dialog                            {:data               [{:data [{:type "empty", :duration 0}
                                                                       ...
                                                                       :editor-type        "dialog",
                                                                       :phrase-description "Question text"},
                   :question-1-options-option-3-voice-over-inactivate {:data [{:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-3-voice-over-background"}
                                                                              {:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-3-voice-over-icon"}],
                                                                       :tags ["inactivate-voice-overs-question-1-question-id"
                                                                              "inactivate-voice-over-option-3-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :start-background-music                            {:id "/upload/LGFWFEKYFMZRKXYS.mp3", :loop true, :type "audio", :volume "0.1"},
                   :wrong-answer-r2                                   {:data               [{:data [{:type "empty", :duration 0}
                                                                                                    {:end         0.483,
                   ...
                   :question-1-options-option-2-substrate-inactivate  {:id     "default",
                                                                       :tags   ["inactivate-options-question-1-question-id"
                                                                                "inactivate-option-option-2-question-1-question-id"],
                                                                       :type   "state",
                   ...
                   :correct-answer-r1                                 {:data               [{:data [{:type "empty", :duration 0}
                                                                       ...
                                                                       :editor-type        "dialog",
                                                                       :phrase-description "correct answer"},
                   :question-1-options-option-4-substrate-inactivate  {:id     "default",
                                                                       :tags   ["inactivate-options-question-1-question-id"
                                                                                "inactivate-option-option-4-question-1-question-id"],
                                                                       :type   "state",
                                                                       :target "question-1-options-option-4-substrate"},
                   :object-revert-r3                                  {:id          "init-position",
                                                                       :type        "state",
                                                                       :from-params [{:param-property "self", :action-property "target"}]},
                   :init-activity-r0                                  {:data [{:type "start-activity"}
                   ...
                   :highlight-r3                                      {:data [{:type "set-variable", :var-name "highlighted", :var-value true}
                                                                       ...
                                                                       :type "sequence-data"},
                   :empty-r3                                          {:type "empty", :duration 100},
                   :question-1-options-option-3-voice-over-activate   {:data [{:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-3-voice-over-background"}
                                                                              {:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-3-voice-over-icon"}],
                                                                       :tags ["activate-voice-over-option-3-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :finish-activity-r3                                {:type "finish-activity"},
                   :green-color-r3                                    {:data               [{:data [{:type "empty", :duration 0}
                                                                                                    {:end         8.85,
                   ...
                   :instruction-1-r3                                  {:data               [{:data [{:type "empty", :duration "1000"}
                                                                       ...
                                                                       :editor-type        "dialog",
                                                                       :phrase-description "Put the red crayon in its crayon box."},
                   :question-1-options-option-1-voice-over-inactivate {:data [{:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-1-voice-over-background"}
                                                                              {:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-1-voice-over-icon"}],
                                                                       :tags ["inactivate-voice-overs-question-1-question-id"
                                                                              "inactivate-voice-over-option-1-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :highlight-r1                                      {:data [{:type        "set-variable",
                                                                               :var-value   true,
                                                                               :from-params [{:param-property "check-variable", :action-property "var-name"}]}
                   ...
                   :question-1-options-option-2-substrate-activate    {:id     "active",
                                                                       :tags   ["activate-option-option-2-question-1-question-id"],
                                                                       :type   "state",
                                                                       :target "question-1-options-option-2-substrate"},
                   :question-1-options-option-4-voice-over-activate   {:data [{:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-4-voice-over-background"}
                                                                              {:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-4-voice-over-icon"}],
                                                                       :tags ["activate-voice-over-option-4-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :check-collide-r1                                  {:data [{:fail          "unhighlight-r1",
                                                                               :type          "test-transitions-and-pointer-collide",
                                                                               :success       "highlight-r1",
                   ...
                   :question-0-options-option-0-substrate-activate    {:id     "active",
                                                                       ...
                                                                       :type   "state",
                                                                       :target "question-0-options-option-0-substrate"},
                   :question-1-options-option-4-substrate-activate    {:id     "active",
                                                                       :tags   ["activate-option-option-4-question-1-question-id"],
                                                                       :type   "state",
                                                                       :target "question-1-options-option-4-substrate"},
                   :question-1-option-voice-over-voice-over-option-3  {:data               [{:data [{:type "empty", :duration 0}
                                                                                                    {:type        "animation-sequence",
                                                                                                     :audio       nil,
                                                                                                     :phrase-text "Option 3"}],
                                                                                             :type "sequence-data"}],
                                                                       :type               "sequence-data",
                                                                       :editor-type        "dialog",
                                                                       :phrase-description "Option \"Option 3\" voice-over"},
                   ...
                   :blue-color-r1                                     {:data               [{:data [{:type "empty", :duration 0}
                                                                       ...
                                                                       :editor-type        "dialog",
                                                                       :phrase-description "Color blue"},
                   :question-1-option-voice-over-voice-over-option-4  {:data               [{:data [{:type "empty", :duration 0}
                                                                                                    {:type        "animation-sequence",
                                                                                                     :audio       nil,
                                                                                                     :phrase-text "Option 4"}],
                                                                                             :type "sequence-data"}],
                                                                       :type               "sequence-data",
                                                                       :editor-type        "dialog",
                                                                       :phrase-description "Option \"Option 4\" voice-over"},
                   ...
                   :question-1-options-option-3-substrate-activate    {:id     "active",
                                                                       :tags   ["activate-option-option-3-question-1-question-id"],
                                                                       :type   "state",
                                                                       :target "question-1-options-option-3-substrate"},
                   :purple-color-r3                                   {:data               [{:data [{:type "empty", :duration 0}
                                                                                                    {:end         11.58,
                   ...
                   :crayon-in-right-box-r1                            {:type        "set-attribute",
                                                                       ...
                                                                       :attr-value  false,
                                                                       :from-params [{:param-property "target", :action-property "target"}]},
                   :question-1-options-option-2-voice-over-activate   {:data [{:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-2-voice-over-background"}
                                                                              {:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-2-voice-over-icon"}],
                                                                       :tags ["activate-voice-over-option-2-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :question-0-options-option-1-voice-over-inactivate {:data [{:id     "default",
                                                                               :type   "state",
                                                                               :target "question-0-options-option-1-voice-over-background"}
                                                                       ...
                                                                       :tags ["inactivate-voice-overs-question-0-question-id"
                                                                              "inactivate-voice-over-option-2-question-0-question-id"],
                                                                       :type "sequence-data"},
                   :question-1-option-voice-over                      {:data [{:type        "parallel-by-tag",
                                                                               :from-params [{:template        "activate-voice-over-%-question-1-question-id",
                                                                                              :param-property  "value",
                                                                                              :action-property "tag"}]}
                                                                              {:type        "case",
                                                                               :options     {:option-1 {:id   "question-1-option-voice-over-voice-over-option-1",
                                                                                                        :type "action"},
                                                                                             :option-2 {:id   "question-1-option-voice-over-voice-over-option-2",
                                                                                                        :type "action"},
                                                                                             :option-3 {:id   "question-1-option-voice-over-voice-over-option-3",
                                                                                                        :type "action"},
                                                                                             :option-4 {:id   "question-1-option-voice-over-voice-over-option-4",
                                                                                                        :type "action"}},
                                                                               :from-params [{:param-property "value", :action-property "value"}]}
                                                                              {:type        "parallel-by-tag",
                                                                               :from-params [{:template        "inactivate-voice-over-%-question-1-question-id",
                                                                                              :param-property  "value",
                                                                                              :action-property "tag"}]}],
                                                                       :type "sequence-data"},
                   :continue-sorting-r1                               {:data               [{:data [{:type "empty", :duration 0}
                   ...
                   :question-0-options-option-3-voice-over-inactivate {:data [{:id     "default",
                                                                       ...
                                                                       :tags ["inactivate-voice-overs-question-0-question-id"
                                                                              "inactivate-voice-over-option-4-question-0-question-id"],
                                                                       :type "sequence-data"},
                   :question-1-option-voice-over-voice-over-option-2  {:data               [{:data [{:type "empty", :duration 0}
                                                                                                    {:type        "animation-sequence",
                                                                                                     :audio       nil,
                                                                       ...
                                                                       :editor-type        "dialog",
                                                                       :phrase-description "Option \"Option 2\" voice-over"},
                   :question-1-options-option-2-voice-over-inactivate {:data [{:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-2-voice-over-background"}
                                                                              {:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-2-voice-over-icon"}],
                                                                       :tags ["inactivate-voice-overs-question-1-question-id"
                                                                              "inactivate-voice-over-option-2-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :highlight-r2                                      {:data [{:type        "set-variable",
                                                                               :var-value   true,
                                                                               :from-params [{:param-property "check-variable", :action-property "var-name"}]}
                   ...
                   :question-1-options-option-1-substrate-activate    {:id     "active",
                                                                       :tags   ["activate-option-option-1-question-1-question-id"],
                                                                       :type   "state",
                   ...
                   :question-1-options-option-1-substrate-inactivate  {:id     "default",
                                                                       :tags   ["inactivate-options-question-1-question-id"
                                                                                "inactivate-option-option-1-question-1-question-id"],
                                                                       :type   "state",
                                                                       :target "question-1-options-option-1-substrate"},
                   :next-check-collide-r1                             {:data [{:type "set-timeout", :action "check-collide-r1", :interval 10}],
                                                                       :type "sequence-data"},
                   ...
                   :check-collide-r3                                  {:data [{:fail        "unhighlight-r3",
                                                                              ...
                                                                              {:id "check-next-check-collide-r3", :type "action"}],
                                                                       :type "sequence-data"},
                   :question-1-options-option-1-voice-over-activate   {:data [{:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-1-voice-over-background"}
                                                                              {:id     "active",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-1-voice-over-icon"}],
                                                                       :tags ["activate-voice-over-option-1-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :stop-drag-highlighted-r3                          {:fail      "wrong-answer-r3",
                                                                       :type      "test-var-list",
                                                                       :values    [true true],
                   ...
                   :init-technical-3                                  {:data [{:id "hide-technical", :type "state", :target "orange-crayon-1-r2"}
                                                                              ...
                                                                              {:id "show-technical", :type "state", :target "orange-table-r3"}],
                                                                       :type "parallel"},
                   :question-1-option-voice-over-voice-over-option-1  {:data               [{:data [{:type "empty", :duration 0}
                                                                                                    {:type        "animation-sequence",
                                                                                                     :audio       nil,
                   ...
                   :unhighlight-all-r1                                {:data [{:type       "set-attribute",
                                                                              ...
                                                                              {:type       "set-attribute",
                                                                               ...
                                                                               :attr-value false}],
                                                                       :type "parallel"},
                   :question-1-options-option-4-voice-over-inactivate {:data [{:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-4-voice-over-background"}
                                                                              {:id     "default",
                                                                               :type   "state",
                                                                               :target "question-1-options-option-4-voice-over-icon"}],
                                                                       :tags ["inactivate-voice-overs-question-1-question-id"
                                                                              "inactivate-voice-over-option-4-question-1-question-id"],
                                                                       :type "sequence-data"},
                   :intermediate-action-3                             {:data [{:id "init-technical-3", :type "action"}
                                                                              {:id "start-activity-r3", :type "action"}],
                                                                       :type "sequence-data"},
   ...
   :objects       {:blue-table-r0                                     {:x      330,
                   ...
                   :question-0-options-option-0-voice-over-icon       {:y          24,
                                                                       ...
                                                                       :height     32,
                                                                       :data       "M20.86 0.199576C20.5352 0.0590597 20.1789 0.00723956 19.8276 0.0494034C19.4762 0.0915673 19.1423 0.226205 18.86 0.439575L9.3 7.99958H2C1.46957 7.99958 0.960859 8.21029 0.585786 8.58536C0.210714 8.96043 0 9.46914 0 9.99957V21.9996C0 22.53 0.210714 23.0387 0.585786 23.4138C0.960859 23.7889 1.46957 23.9996 2 23.9996H9.3L18.76 31.5596C19.1119 31.8419 19.5489 31.997 20 31.9996C20.2987 32.0045 20.5941 31.9358 20.86 31.7996C21.2003 31.6375 21.4879 31.3825 21.6897 31.064C21.8914 30.7455 21.9989 30.3765 22 29.9996V1.99958C21.9989 1.6226 21.8914 1.25361 21.6897 0.935133C21.4879 0.616658 21.2003 0.361673 20.86 0.199576ZM18 25.8396L11.24 20.4396C10.8881 20.1573 10.4511 20.0022 10 19.9996H4V11.9996H10C10.4511 11.997 10.8881 11.8419 11.24 11.5596L18 6.15957V25.8396ZM35.32 4.67958C34.9434 4.30297 34.4326 4.09139 33.9 4.09139C33.3674 4.09139 32.8566 4.30297 32.48 4.67958C32.1034 5.05618 31.8918 5.56697 31.8918 6.09958C31.8918 6.63218 32.1034 7.14297 32.48 7.51958C33.6577 8.69545 34.5779 10.1034 35.1823 11.6541C35.7866 13.2047 36.0617 14.8641 35.9902 16.5268C35.9188 18.1895 35.5022 19.8192 34.7671 21.3122C34.0319 22.8053 32.9943 24.1291 31.72 25.1996C31.4105 25.4642 31.1892 25.8169 31.0856 26.2107C30.982 26.6045 31.001 27.0205 31.1402 27.4032C31.2793 27.7858 31.5319 28.1169 31.8643 28.3521C32.1966 28.5874 32.5929 28.7156 33 28.7196C33.4673 28.7205 33.9202 28.5577 34.28 28.2596C35.9819 26.8342 37.3685 25.0702 38.3517 23.0798C39.3349 21.0895 39.8932 18.9163 39.991 16.6985C40.0888 14.4807 39.7241 12.2668 38.9199 10.1977C38.1157 8.12848 36.8898 6.24928 35.32 4.67958ZM29.66 10.3396C29.4735 10.1531 29.2521 10.0052 29.0085 9.90425C28.7649 9.80333 28.5037 9.75139 28.24 9.75139C27.9763 9.75139 27.7152 9.80333 27.4715 9.90425C27.2279 10.0052 27.0065 10.1531 26.82 10.3396C26.6335 10.5261 26.4856 10.7474 26.3847 10.9911C26.2838 11.2347 26.2318 11.4959 26.2318 11.7596C26.2318 12.0233 26.2838 12.2844 26.3847 12.5281C26.4856 12.7717 26.6335 12.9931 26.82 13.1796C27.5712 13.9263 27.9955 14.9404 28 15.9996C28.0005 16.5823 27.8736 17.158 27.6284 17.6866C27.3831 18.2152 27.0253 18.6837 26.58 19.0596C26.3775 19.2275 26.2101 19.4337 26.0874 19.6664C25.9647 19.8991 25.8891 20.1537 25.8649 20.4156C25.8408 20.6776 25.8685 20.9417 25.9466 21.1929C26.0247 21.4441 26.1516 21.6775 26.32 21.8796C26.4893 22.0806 26.6966 22.2464 26.93 22.3672C27.1634 22.4881 27.4184 22.5618 27.6803 22.5841C27.9422 22.6064 28.2059 22.5769 28.4564 22.4972C28.7069 22.4174 28.9392 22.2891 29.14 22.1196C30.0342 21.3698 30.7536 20.4335 31.2477 19.3763C31.7417 18.319 31.9985 17.1665 32 15.9996C31.9887 13.8798 31.1489 11.8485 29.66 10.3396Z"},
                   :question-1-options-option-2-voice-over-background {:x             0,
                                                                       :y             0,
                                                                       :fill          16777215,
                                                                       :type          "rectangle",
                                                                       :width         80,
                   ...
                   :librarian-r2                                      {:y         1000,
                                                                       ...
                                                                       :skin      "lion",
                                                                       :height    717},
                   :question-1-options-option-4-voice-over-background {:x             0,
                                                                       :y             0,
                                                                       :fill          16777215,
                                                                       :type          "rectangle",
                                                                       :width         80,
                   ...
                   :red-crayon-2-r2                                   {:y         958,
                                                                       ...
                                                                       :x         1618,
                                                                       :visible   false},
                   :question-1-options-option-3-voice-over            {:x        0,
                                                                       :y        0,
                                                                       :type     "group",
                                                                       :actions  {:click {:id         "question-1-option-voice-over",
                                                                                          :on         "click",
                                                                                          :type       "action",
                                                                                          :params     {:value "option-3"},
                                                                                          :unique-tag "question-action"}},
                                                                       :children ["question-1-options-option-3-voice-over-background"
                                                                                  "question-1-options-option-3-voice-over-icon"]},
                   :question-1-options-option-2-voice-over-icon       {:y          24,
                                                                       :states     {:active {:fill "#FFFFFF"}, :default {:fill "#000000"}},
                                                                       :fill       "#000000",
                                                                       :width      41,
                                                                       :type       "svg-path",
                                                                       ...
                                                                       :height     32,
                                                                       :data       "M20.86 0.199576C20.5352 0.0590597 20.1789 0.00723956 19.8276 0.0494034C19.4762 0.0915673 19.1423 0.226205 18.86 0.439575L9.3 7.99958H2C1.46957 7.99958 0.960859 8.21029 0.585786 8.58536C0.210714 8.96043 0 9.46914 0 9.99957V21.9996C0 22.53 0.210714 23.0387 0.585786 23.4138C0.960859 23.7889 1.46957 23.9996 2 23.9996H9.3L18.76 31.5596C19.1119 31.8419 19.5489 31.997 20 31.9996C20.2987 32.0045 20.5941 31.9358 20.86 31.7996C21.2003 31.6375 21.4879 31.3825 21.6897 31.064C21.8914 30.7455 21.9989 30.3765 22 29.9996V1.99958C21.9989 1.6226 21.8914 1.25361 21.6897 0.935133C21.4879 0.616658 21.2003 0.361673 20.86 0.199576ZM18 25.8396L11.24 20.4396C10.8881 20.1573 10.4511 20.0022 10 19.9996H4V11.9996H10C10.4511 11.997 10.8881 11.8419 11.24 11.5596L18 6.15957V25.8396ZM35.32 4.67958C34.9434 4.30297 34.4326 4.09139 33.9 4.09139C33.3674 4.09139 32.8566 4.30297 32.48 4.67958C32.1034 5.05618 31.8918 5.56697 31.8918 6.09958C31.8918 6.63218 32.1034 7.14297 32.48 7.51958C33.6577 8.69545 34.5779 10.1034 35.1823 11.6541C35.7866 13.2047 36.0617 14.8641 35.9902 16.5268C35.9188 18.1895 35.5022 19.8192 34.7671 21.3122C34.0319 22.8053 32.9943 24.1291 31.72 25.1996C31.4105 25.4642 31.1892 25.8169 31.0856 26.2107C30.982 26.6045 31.001 27.0205 31.1402 27.4032C31.2793 27.7858 31.5319 28.1169 31.8643 28.3521C32.1966 28.5874 32.5929 28.7156 33 28.7196C33.4673 28.7205 33.9202 28.5577 34.28 28.2596C35.9819 26.8342 37.3685 25.0702 38.3517 23.0798C39.3349 21.0895 39.8932 18.9163 39.991 16.6985C40.0888 14.4807 39.7241 12.2668 38.9199 10.1977C38.1157 8.12848 36.8898 6.24928 35.32 4.67958ZM29.66 10.3396C29.4735 10.1531 29.2521 10.0052 29.0085 9.90425C28.7649 9.80333 28.5037 9.75139 28.24 9.75139C27.9763 9.75139 27.7152 9.80333 27.4715 9.90425C27.2279 10.0052 27.0065 10.1531 26.82 10.3396C26.6335 10.5261 26.4856 10.7474 26.3847 10.9911C26.2838 11.2347 26.2318 11.4959 26.2318 11.7596C26.2318 12.0233 26.2838 12.2844 26.3847 12.5281C26.4856 12.7717 26.6335 12.9931 26.82 13.1796C27.5712 13.9263 27.9955 14.9404 28 15.9996C28.0005 16.5823 27.8736 17.158 27.6284 17.6866C27.3831 18.2152 27.0253 18.6837 26.58 19.0596C26.3775 19.2275 26.2101 19.4337 26.0874 19.6664C25.9647 19.8991 25.8891 20.1537 25.8649 20.4156C25.8408 20.6776 25.8685 20.9417 25.9466 21.1929C26.0247 21.4441 26.1516 21.6775 26.32 21.8796C26.4893 22.0806 26.6966 22.2464 26.93 22.3672C27.1634 22.4881 27.4184 22.5618 27.6803 22.5841C27.9422 22.6064 28.2059 22.5769 28.4564 22.4972C28.7069 22.4174 28.9392 22.2891 29.14 22.1196C30.0342 21.3698 30.7536 20.4335 31.2477 19.3763C31.7417 18.319 31.9985 17.1665 32 15.9996C31.9887 13.8798 31.1489 11.8485 29.66 10.3396Z"},
                   :question-1-options-option-4-substrate             {:y             0,
                                                                       :states        {:active {:border-color 45823}, :default {:border-color 0}},
                                                                       :fill          16777215,
                                                                       :width         760,
                                                                       :type          "rectangle",
                   ...
                   :blue-box-r3                                       {:x       1352,
                                                                       ...
                                                                       :states  {:hide-technical {:visible false}, :show-technical {:visible true}},
                                                                       :visible false},
                   :question-1-question-id--option-2-text             {:y              50,
                                                                       :vertical-align "middle",
                                                                       :font-size      48,
                                                                       :word-wrap      true,
                                                                       :width          720,
                   ...
                   :question-0-background                             {:x           0,
                                                                       ...
                                                                       :height      667.4713521772346,
                                                                       :object-name "question-0-background"},
                   :question-1-question-id--option-3-text             {:y              50,
                                                                       :vertical-align "middle",
                                                                       :font-size      48,
                                                                       :word-wrap      true,
                                                                       :width          720,
                   ...
                   :question-0-options-option-3-text                  {:y              50,
                                                                       ...
                                                                       :x              130,
                                                                       :text           "They are both books."},
                   :question-1-options-option-3-voice-over-background {:x             0,
                                                                       :y             0,
                                                                       :fill          16777215,
                                                                       :type          "rectangle",
                                                                       :width         80,
                   ...
                   :blue-crayon-3-r2                                  {:y         143,
                                                                       ...
                                                                       :x         17,
                                                                       :visible   false},
                   :question-1-options-option-3                       {:x        60,
                                                                       :y        363.7356760886173,
                                                                       :type     "group",
                                                                       :children ["question-1-options-option-3-substrate"
                                                                                  "question-1-options-option-3-voice-over"
                                                                                  "question-1-question-id--option-3-text"]},
                   :question-1-question-id--option-1-text             {:y              50,
                                                                       :vertical-align "middle",
                                                                       :font-size      48,
                                                                       :word-wrap      true,
                                                                       :width          720,
                   ...
                   :blue-crayon-1-r2                                  {:y         1050,
                                                                       ...
                                                                       :x         46,
                                                                       :visible   false},
                   :question-1-options-option-4-voice-over-icon       {:y          24,
                                                                       :states     {:active {:fill "#FFFFFF"}, :default {:fill "#000000"}},
                                                                       :fill       "#000000",
                                                                       :width      41,
                                                                       :type       "svg-path",
                   ...
                   :red-crayon-1-r1                                   {:y          64,
                                                                       ...
                                                                       :x          760,
                                                                       :visible    false},
                   :question-1-options-option-4-voice-over            {:x        0,
                                                                       :y        0,
                                                                       :type     "group",
                                                                       :actions  {:click {:id         "question-1-option-voice-over",
                                                                                          :on         "click",
                                                                                          ...
                                                                                          :params     {:value "option-4"},
                                                                                          :unique-tag "question-action"}},
                                                                       :children ["question-1-options-option-4-voice-over-background"
                                                                                  "question-1-options-option-4-voice-over-icon"]},
                   :question-1-options-option-2-voice-over            {:x        0,
                                                                       :y        0,
                                                                       :type     "group",
                                                                       :actions  {:click {:id         "question-1-option-voice-over",
                                                                                          :on         "click",
                                                                                          ...
                                                                                          :params     {:value "option-2"},
                                                                                          :unique-tag "question-action"}},
                                                                       :children ["question-1-options-option-2-voice-over-background"
                                                                                  "question-1-options-option-2-voice-over-icon"]},
                   :purple-table-r2                                   {:x       745,
                                                                       :y       773,
                                                                       :src     "/raw/img/categorize/purple_table.png",
                                                                       :type    "image",
                   ...
                   :question-0-options-option-3-substrate             {:y             0,
                                                                       ...
                                                                       :border-radius 20,
                                                                       :height        100},
                   :question-1-options-option-1-voice-over            {:x        0,
                                                                       :y        0,
                                                                       :type     "group",
                                                                       :actions  {:click {:id         "question-1-option-voice-over",
                                                                                          :on         "click",
                                                                                          ...
                                                                                          :params     {:value "option-1"},
                                                                                          :unique-tag "question-action"}},
                                                                       :children ["question-1-options-option-1-voice-over-background"
                                                                                  "question-1-options-option-1-voice-over-icon"]},
                   :question-1-options-option-1-voice-over-background {:x             0,
                                                                       :y             0,
                                                                       :fill          16777215,
                                                                       :type          "rectangle",
                                                                       :width         80,
                   ...
                   :yellow-crayon-2-r1                                {:y          279,
                                                                       ...
                                                                       :x          1071,
                                                                       :visible    false},
                   :question-1-question-id--option-4-text             {:y              50,
                                                                       :vertical-align "middle",
                                                                       :font-size      48,
                                                                       :word-wrap      true,
                                                                       :width          720,
                   ...
                   :orange-crayon-2-r1                                {:y          456,
                                                                       ...
                                                                       :x          1406,
                                                                       :visible    false},
                   :question-1-options-option-2                       {:x        990,
                                                                       :y        203.7356760886173,
                                                                       :type     "group",
                                                                       :children ["question-1-options-option-2-substrate"
                                                                                  "question-1-options-option-2-voice-over"
                                                                                  "question-1-question-id--option-2-text"]},
                   ...
                   :question-1-options-option-3-voice-over-icon       {:y          24,
                                                                       :states     {:active {:fill "#FFFFFF"}, :default {:fill "#000000"}},
                                                                       :fill       "#000000",
                                                                       :width      41,
                                                                       :type       "svg-path",
                   ...
                   :question-1                                        {:x         0,
                                                                       ...
                                                                       :metadata  {:assets    ["/images/questions/question.png"],
                                                                                   ...
                                                                                   :actions   ["question-1-options-option-3-substrate-inactivate"
                                                                                               ...
                                                                                               "question-1-options-option-3-voice-over-inactivate"
                                                                                               ...
                                                                                               "question-1-options-option-4-substrate-inactivate"
                                                                                               "question-1-hide"
                                                                                               "question-1-task-text-group-button-activate"
                                                                                               "question-1-task-text-group-button-inactivate"
                                                                                               "question-1-task-dialog"
                                                                                               "question-1-options-option-3-voice-over-activate"
                                                                                               "question-1-options-option-1-voice-over-inactivate"
                                                                                               "question-1-options-option-2-substrate-activate"
                                                                                               "question-1-options-option-4-voice-over-activate"
                                                                                               "question-1-options-option-4-substrate-activate"
                                                                                               "question-1-option-voice-over-voice-over-option-3"
                                                                                               "question-1-option-voice-over-voice-over-option-4"
                                                                                               "question-1-options-option-3-substrate-activate"
                                                                                               "question-1-check-answers-wrong-answer-dialog"
                                                                                               "question-1-options-option-2-voice-over-activate"
                                                                                               "question-1-option-voice-over"
                                                                                               "question-1-option-voice-over-voice-over-option-2"
                                                                                               "question-1-options-option-2-voice-over-inactivate"
                                                                                               ...
                                                                                               "question-1-options-option-1-voice-over-activate"
                                                                                               "question-1-option-voice-over-voice-over-option-1"
                                                                                               "question-1-options-option-4-voice-over-inactivate"],
                                                                                   :objects   ["question-1-options-option-2-voice-over-background"
                                                                                               "question-1-options-option-2-substrate"
                                                                                               "question-1-options-option-4-voice-over-background"
                                                                                               "question-1-options-option-3-voice-over"
                                                                                               "question-1-options-option-2-voice-over-icon"
                                                                                               "question-1-options-option-4-substrate"
                                                                                               "question-1-task-text-group-button-icon"
                                                                                               ...
                                                                                               "question-1-options-option-3-voice-over-background"
                                                                                               "question-1-options-option-3"
                                                                                               "question-1-question-id--option-1-text"
                                                                                               "question-1-options-option-4-voice-over-icon"
                                                                                               "question-1-options"
                                                                                               "question-1-options-option-4-voice-over"
                                                                                               "question-1-options-option-2-voice-over"
                                                                                               "question-1-options-option-1-substrate"
                                                                                               "question-1-task-text-group"
                                                                                               "question-1-options-option-1-voice-over"
                                                                                               "question-1-options-option-1-voice-over-background"
                                                                                               "question-1-task-text-group-button"
                                                                                               "question-1-question-id--option-4-text"
                                                                                               "question-1-options-option-2"
                                                                                               "question-1-question-id--task-text"
                                                                                               "question-1-options-option-3-voice-over-icon"
                                                                                               "question-1"
                   ...
                   :question-0-options-option-1-substrate             {:y             0,
                                                                       ...
                                                                       :border-radius 20,
                                                                       :height        100},
                   :question-1-options-option-1                       {:x        60,
                                                                       :y        203.7356760886173,
                                                                       :type     "group",
                   ...
                   :question-0-options-option-0                       {:x        60,
                                                                       ...
                                                                       :children ["question-0-options-option-0-substrate"
                                                                                  "question-0-options-option-0-voice-over"
                                                                                  "question-0-options-option-0-text"]},
                   :question-1-options-option-4                       {:x        990,
                                                                       :y        363.7356760886173,
                                                                       :type     "group",
                                                                       :children ["question-1-options-option-4-substrate"
                                                                                  "question-1-options-option-4-voice-over"
                                                                                  "question-1-question-id--option-4-text"]},
                   :question-1-options-option-1-voice-over-icon       {:y          24,
                                                                       :states     {:active {:fill "#FFFFFF"}, :default {:fill "#000000"}},
                                                                       :fill       "#000000",
                                                                       :width      41,
                                                                       :type       "svg-path",
   ...
   :metadata      {:template-name     "Categorize - Colors",
                   ...
                   :tracks            [{:nodes       [{:type "dialog", :action-id "question-0-task-dialog"}
                                       ...
                                       {:nodes [{:type "dialog", :action-id "yellow-color-r3"}
                                                ...
                                                {:type "dialog", :action-id "green-color-r3"}],
                                        :title "Round 3 - colors"}
                                       {:nodes       [{:type "dialog", :action-id "question-1-task-dialog"}
                                                      ...
                                                      {:type "dialog", :action-id "question-1-option-voice-over-voice-over-option-1"}
                                                      {:type "dialog", :action-id "question-1-option-voice-over-voice-over-option-2"}
                                                      {:type "dialog", :action-id "question-1-option-voice-over-voice-over-option-3"}
                                                      {:type "dialog", :action-id "question-1-option-voice-over-voice-over-option-4"}],
                                        :title       "Q1",
                   ...
                   :history           {:created {:template-id 22},
                                       :updated [{:data           {:background-music {:src "/upload/LGFWFEKYFMZRKXYS.mp3", :volume "0.1"}},
                                                 ...
                                                 {:data           {:question-page-object {:answers-number  "one",
                                                  ...
                                                  :common-action? true}
                                                 {:data           {:data-version         2,
                                                                   :question-page-object {:options-label   "audio-text",
                                                                                          :answers-number  "one",
                                                                                          :layout          "vertical",
                                                                                          :task-type       "text-image",
                                                                                          :question-type   "multiple-choice-text",
