  ...
  {:assets
   ...
   :actions
                  {:mari-welcome-audio-1
                   ...
                   :mari-move-to-start
                   {:type "parallel"
                    :data [{:type "audio", :id "mari-welcome", :start 34.395, :duration 2.773}
                   ...
                   {:type "sequence-data"
                    :data [{:type "parallel"
                            :data [{:type "audio", :id "rock-ardilla", :start 0.68, :duration 6.4}
                                   {:type "animation-sequence" :target "rock" :track 1 :offset 0.68
                                    :data [{:start 1.172 :end 1.676 :anim "talk"}
                                           {:start 2.204 :end 3.604 :anim "talk"}
                                           {:start 4.044 :end 6.629 :anim "talk"}]}]}
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-ardilla", :start 0.328, :duration 1.835}
                                   {:type "animation-sequence" :target "vera" :track 1 :offset 0.328
                                    :data [{:start 0.447 :end 2.016 :anim "talk"}]}]}
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-ardilla", :start 10.356, :duration 6.166}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-ardilla", :start 3.667, :duration 2.966}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-ardilla", :start 17.847, :duration 5.339}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-ardilla", :start 7.8, :duration 8.923}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-ardilla", :start 24.176, :duration 9.073}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-ardilla", :start 18.21, :duration 9.603}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-ardilla", :start 34.2, :duration 6.482}
                   ...
                   {:type "sequence-data"
                    :data [{:type "parallel"
                            :data [{:type "audio", :id "rock-oso", :start 0.481, :duration 5.775}
                                   {:type "animation-sequence" :target "rock" :track 1 :offset 0.481
                                    :data [{:start 0.605 :end 2.887 :anim "talk"}
                                           {:start 3.504 :end 5.726 :anim "talk"}]}]}
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-oso", :start 0.924, :duration 5.258}
                                   {:type "animation-sequence" :target "vera" :track 1 :offset 0.924
                                    :data [{:start 1.071 :end 5.972 :anim "talk"}]}]}
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-oso", :start 6.54, :duration 3.936}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-oso", :start 6.92, :duration 5.036}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-oso", :start 11.013, :duration 9.933}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-oso", :start 12.744, :duration 8.41}
                   ...
                   {:type "sequence-data"
                    :data [{:type "parallel"
                            :data [{:type "audio", :id "rock-iman", :start 0.573, :duration 4.29}
                                   {:type "animation-sequence" :target "rock" :track 1 :offset 0.573
                                    :data [{:start 0.745 :end 1.596 :anim "talk"}
                                           {:start 2.284 :end 2.685 :anim "talk"}
                                           {:start 2.964 :end 4.577 :anim "talk"}]}]}
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-iman", :start 0.411, :duration 4.493}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-iman", :start 5.207, :duration 10.93}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-iman", :start 6.264, :duration 2.746}
                                   {:type "animation-sequence" :target "vera" :track 1 :offset 6.264
                                    :data [{:start 6.424 :end 8.826 :anim "talk"}]}]}
                           {:type "parallel"
                            :data [{:type "audio", :id "rock-iman", :start 16.767, :duration 11.282}
                           ...
                           {:type "parallel"
                            :data [{:type "audio", :id "vera-iman", :start 10.161, :duration 3.964}
