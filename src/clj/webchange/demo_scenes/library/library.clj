(ns webchange.demo-scenes.library.library)

(def library-scene {:assets [{:url "/raw/img/library/main/background.jpg", :size 10, :type "image"}
                 ...
                 :objects {:background {:type "background", :src "/raw/img/library/main/background.jpg"},
                           ...
                           :librarian {:type "animation" :x 451 :y 883 :name "senoravaca" :anim "idle" :speed 0.3
                           ...
                           {:type "sequence-data",
                            :data
                                  [{:type "animation-sequence",
                                    ...
                                    :duration 4.367,
                                    :data
                                    [{:start 2.348, :end 4.417, :duration 2.069, :anim "talk"}
                                   ...
                                   {:type "animation-sequence",
                                    ...
                                    :duration 4.184,
                                    :data
                                    [{:start 0.504, :end 2.073, :duration 1.569, :anim "talk"}
                                   ...
                                   {:type "animation-sequence",
                                    ...
                                    :duration 5.407,
                                    :data
                                    [{:start 9.295, :end 10.457, :duration 1.162, :anim "talk"}
