(ns webchange.demo-scenes.stadium.cycling)

(def cycling-scene {:assets [{:url "/raw/img/stadium/cycling/cycle_race_bg_01.jpg", :size 10, :type "image"}
                             ...
                             {:url "/raw/audio/l1/a8/Mari_L1_A8.m4a", :size 2, :type "audio" :alias "mari"}
                             {:url "/raw/audio/l1/a8/GameVoice.m4a", :size 2, :type "audio" :alias "game voice"}
                    ...
                    :actions {:start
                              ...
                              {:type "animation-sequence",
                               ...
                               :duration 10.782,
                               :data
                               [{:start 1.012, :end 2.225, :duration 1.213, :anim "talk"}
