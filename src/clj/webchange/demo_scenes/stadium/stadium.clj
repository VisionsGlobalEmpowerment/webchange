...
(def stadium-scene {:assets        [{:url "/raw/img/stadium/main/Stadium_Sketch.jpg", :size 10, :type "image"}]
                    ...
                    :objects       {:background {:type "background" :src "/raw/img/stadium/main/Stadium_Sketch.jpg"}
                                    ...
                                    :volleyball {:type    "transparent"
                                                 :x       683
                                                 :y       539
                                                 :width   350
                                                 :height  500
                                                 :actions {:click {:type     "scene"
                                                                   :scene-id "volleyball"
                                                                   :on       "click"}}}
                                    :cycling    {:type    "transparent"
                                                 :x       125
                                                 :y       539
                                                 :width   450
                                                 :height  500
                    ...
                    :triggers      {:music {:on     "start"
                                            :action "start-background-music"}}
