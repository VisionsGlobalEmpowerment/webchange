...
(def template-round-2 {:assets        [
                       ...
                       :actions       {:object-in-right-box {:type        "set-attribute", :attr-name "visible" :attr-value false
                                       ...
                                       :big-item            (-> (dialog/default "big")
                                                                (assoc :unique-tag "item"))
                                       :big-correct         (-> (dialog/default "big correct")
                                                                (assoc :unique-tag "item"))
                                       :trash-item          (-> (dialog/default "trash")
                                                                (assoc :unique-tag "item"))
                                       :trash-correct       (-> (dialog/default "trash correct")
                                                                (assoc :unique-tag "item"))
                                                   ...
                                                   {:title "Round 2 - items"
                                                    :nodes [{:type      "dialog"
                                                            ...
                                                            {:type      "dialog"
                                                             :action-id :big-item}
                                                            {:type      "dialog"
                                                             :action-id :big-correct}
                                                            {:type      "dialog"
                                                             :action-id :trash-item}
                                                            {:type      "dialog"
                                                             :action-id :trash-correct}
                                                            {:type      "dialog"
