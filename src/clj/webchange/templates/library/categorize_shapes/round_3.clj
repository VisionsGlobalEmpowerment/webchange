...
(def template-round-3 {:assets        [{:url "/raw/img/categorize-shapes/background.png", :size 10, :type "image"}
                       ...
                       :objects       {:background      {:type "background", :src "/raw/img/categorize-shapes/background.png"},
                                       :star-group       {
                                                          :type       "group",
                                                          :children   [],
                                                          :draggable  true,
