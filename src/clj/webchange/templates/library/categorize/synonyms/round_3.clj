...
(def template (round-3-template/get-template
                {:boxes      [(word->box {:word "big" :x 392})
                 ...
                 :items      [(word->item {:word "chilly" :x 768 :y 481})
                              (word->item {:word "large" :x 415 :y 355})
                              (word->item {:word "glad" :x 1674 :y 434})
                              (word->item {:word "afraid" :x 1636 :y 107})
                              (word->item {:word "garbage" :x 1388 :y 561})
                              (word->item {:word "kid" :x 1094 :y 223})]
