...
(s/defschema Template {:id s/Int :name s/Str :description s/Str (s/optional-key :options) (s/maybe s/Any) (s/optional-key :fields) (s/maybe s/Any) (s/optional-key :lesson-sets) (s/maybe s/Any)})
