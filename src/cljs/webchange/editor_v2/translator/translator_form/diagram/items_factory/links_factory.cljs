(ns webchange.editor-v2.translator.translator-form.diagram.items-factory.links-factory
  (:require
    [webchange.editor-v2.translator.translator-form.diagram.items-factory.utils :refer [get-node-connections]]))
