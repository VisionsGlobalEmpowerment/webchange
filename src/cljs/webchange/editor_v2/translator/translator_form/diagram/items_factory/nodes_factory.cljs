(ns webchange.editor-v2.translator.translator-form.diagram.items-factory.nodes-factory
  (:require
    [webchange.editor-v2.diagram-utils.diagram-model.custom-nodes.custom-model :refer [get-custom-model]]
    [webchange.editor-v2.translator.translator-form.diagram.items-factory.utils :refer [get-node-outs]]))
