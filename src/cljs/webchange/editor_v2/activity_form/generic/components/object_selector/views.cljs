(ns webchange.editor-v2.activity-form.generic.components.object-selector.views
  (:require
    [cljs-react-material-ui.reagent :as ui]
    [re-frame.core :as re-frame]
    [webchange.editor-v2.events :as editor-events]
    [webchange.editor-v2.activity-form.generic.components.object-selector.state :as state]))
