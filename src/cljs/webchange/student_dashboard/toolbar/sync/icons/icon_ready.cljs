(ns webchange.student-dashboard.toolbar.sync.icons.icon-ready)
  ...
  (let [{:keys [color]} (merge default-props props)]
    [:svg {:xmlns   "http://www.w3.org/2000/svg"
     ...
     [:g
      ...
      [:g [:path {:fill color :d "M17.505 14.996a.47.47 0 0 1-.35-.15l-2-2a.495.495 0 0 1 .7-.7l1.6 1.59 2.65-3.54a.51.51 0 0 1 .7-.1.5.5 0 0 1 .1.7l-3 4a.49.49 0 0 1-.36.2z"}]]]]))
