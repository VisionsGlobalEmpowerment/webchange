(ns webchange.question.create-multiple-choice-mix
  (:require
...
(defn- create-options
  [{:keys [options-number answers-types] :as form-data}
   layout
   {:keys [text-objects-names question-id] :as props}
   data-names
   creation-options]
