(ns webchange.editor-v2.diagram.graph-builder.scene-parser.data-parser.data-parser-objects-test
  (:require
    [cljs.test :refer [deftest testing is]]
    [webchange.editor-v2.diagram.graph-builder.scene-parser.data-parser.data-parser-objects :refer [parse-object]]))
