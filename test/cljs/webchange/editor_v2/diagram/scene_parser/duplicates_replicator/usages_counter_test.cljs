(ns webchange.editor-v2.diagram.scene-parser.duplicates-replicator.usages-counter-test
  (:require
    [cljs.test :refer [deftest testing is]]
    [utils.compare-maps :refer [print-maps-comparison]]
    [webchange.editor-v2.diagram.scene-parser.duplicates-replicator.usages-counter :refer [count-node-usages
                                                                                           get-reused-nodes]]))
