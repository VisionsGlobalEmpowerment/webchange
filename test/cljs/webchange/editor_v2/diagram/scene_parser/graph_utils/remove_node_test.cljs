(ns webchange.editor-v2.diagram.scene-parser.graph-utils.remove-node-test
  (:require
    [cljs.test :refer [deftest testing is]]
    [utils.compare-maps :refer [print-maps-comparison]]
    [webchange.editor-v2.diagram.scene-parser.graph-utils.remove-node :refer [change-parent-node-connections
