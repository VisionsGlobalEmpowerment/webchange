(ns webchange.editor-v2.diagram.scene-parser.graph-utils.root-nodes-test
  (:require
    [cljs.test :refer [deftest testing is]]
    [utils.compare-maps :refer [print-maps-comparison]]
    [webchange.editor-v2.diagram.scene-parser.graph-utils.root-nodes :refer [get-root-nodes]]))
