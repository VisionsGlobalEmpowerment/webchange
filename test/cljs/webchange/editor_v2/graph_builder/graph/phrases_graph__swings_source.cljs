(ns webchange.editor-v2.graph-builder.graph.phrases-graph--swings-source)
...
(def data {:assets        [{:url "/raw/img/park/swings/background.jpg", :size 10 :type "image"}
                           ...
                           {:url "/raw/audio/english/l1/a3/mari.m4a", :size 2, :type "audio" :alias "mari"}
                           {:url "/raw/audio/english/l1/a3/vera.mp3", :size 2, :type "audio" :alias "vera"}
                           {:url "/raw/audio/english/l1/a3/vera-squirrel.mp3", :size 2, :type "audio" :alias "vera squirrel"}
                           {:url "/raw/audio/english/l1/a3/vera-elephant.mp3", :size 2, :type "audio" :alias "vera elephant"}
                           {:url "/raw/audio/english/l1/a3/vera-magnet.mp3", :size 2, :type "audio" :alias "vera magnet"}
                           {:url "/raw/audio/english/l1/a3/rock.mp3", :size 2, :type "audio" :alias "rock"}
                           {:url "/raw/audio/english/l1/a3/rock-squirrel.mp3", :size 2, :type "audio" :alias "rock squirrel"}
                           {:url "/raw/audio/english/l1/a3/rock-elephant.mp3", :size 2, :type "audio" :alias "rock elephant"}
                           {:url "/raw/audio/english/l1/a3/rock-magnet.mp3", :size 2, :type "audio" :alias "rock magnet"}],
           ...
           :actions       {:welcome-audio              {:type        "sequence"
                                                        ...
                                                        :phrase      :welcome
                                                        :phrase-text "Vera: Hello Mari! Are we going to play on the swings now? I like the swings.
                                                            Mari: Yes! We are going to play on the swings! Our friends [ardilla, oso and imán] want to go on the swings. Let’s give each of them a turn.
                                                            Vera: Ok. I’m going to give everyone a turn.
                                                            Mari: Good job!
                                                            Rock: That’s very kind of you!
                                                            Mari: Oh, hello Senora Piedra! It’s a pleasure to see you.
                                                            Rock: Hello Mari. It’s a pleasure to see you too.
                                                            Vera: Hola Senor Piedra. How are you?
                                                            Rock: Hello my friend. I’m very well, thank you.
                                                            Mari: Ok little genius, let’s begin!"}
                           ...
                           :try-another                {:type        "animation-sequence",
                                                        ...
                                                        :phrase      :try-another
                                                        :phrase-text "Good job little genius!
                                                            Let’s try another one.
                                                            Move this picture to the swings."}
                           ...
                           :mari-finish                {:type        "sequence-data",
                                                        :data        [{:type          "transition",
                                                                      ...
                                                                      {:type     "animation-sequence",
                                                                       ...
                                                                       :duration 12.36}]
                                                        :phrase      :finish
                                                        :phrase-text "It looks like every picture got a turn on the swing.
                                                            Good job little genius!
