(ns webchange.editor-v2.graph-builder.graph.phrases-graph--sandbox-source)

(def data {:assets        [{:url "/raw/audio/l1/a4/Mari_Level1_Activity4.m4a", :size 5, :type "audio" :alias "mari voice"}
                           {:url "/raw/audio/l1/a4/L1_A4_GameVoice_Set_1.m4a", :size 5, :type "audio" :alias "game voice 1"}
                           {:url "/raw/audio/l1/a4/L1_A4_GameVoice_Set_2.m4a", :size 5, :type "audio" :alias "game voice 2"}
                           {:url "/raw/audio/l1/a4/L1_A4_GameVoice_Set_3.m4a", :size 5, :type "audio" :alias "game voice 3"}
           ...
           :actions       {:mari-welcome-audio             {:type        "animation-sequence" :target "mari" :track 1 :offset 0.702
                           ...
                           :letter-intro                   {:type        "sequence"
                                                            :data        ["mari-letter-1"
                                                                          ...
                                                                          "mari-long-letter-var"]
                                                            :phrase      :letter-intro
                                                            :phrase-text "This is the letter a.
                                                                Did you know that the letter a makes the aaa sound?
                                                                Click on the pictures to hear more words that start with the sound aaa."}
