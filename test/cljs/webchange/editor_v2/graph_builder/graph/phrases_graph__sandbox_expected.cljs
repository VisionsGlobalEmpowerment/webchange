...
(def data {:word-1-state-var-copy-1 {:path         [:word-1-state-var]
           ...
           :word-4-state-var-copy-1 {:path         [:word-4-state-var]
                                     :entity       :action
                                     :children     []
                                     :connections  #{{:previous :word-4-state-var-copy-2
                                                      :name     "next"
           ...
           :mari-more-audio         {:path        [:mari-more-audio]
                                     ...
                                     :connections #{{:previous :word-2-state-var-copy-1
                                                    ...
                                                    {:previous :word-3-state-var-copy-1
                                                     ...
                                                     :sequence :next-concept-workflow
                                                     :handler  :letter-intro}
                                                    {:previous :word-4-state-var-copy-1
                                                     :name     "next"
                                                     :sequence :next-concept-workflow
                                                     :handler  :letter-intro}}}
           :letter-intro            {:path        [:letter-intro]
                                     :entity      :action
                                     :children    [:mari-letter-1 :mari-short-letter-var :mari-letter-2 :mari-short-letter-var :mari-letter-3 :mari-long-letter-var :mari-letter-4 :mari-long-letter-var]
                                     :connections #{}}
           :box2                    {:path        [:box2]
                                     :entity      :object
                                     :children    []
