(ns webchange.editor-v2.graph-builder.graph.phrases-graph--home-source)

(def data {:assets        [{:url "/raw/img/casa/background.jpg", :size 10 :type "image"}
                           {:url "/raw/img/casa/door.png", :size 1, :type "image"}
                           {:url "/raw/audio/english/l1/a1/vaca.m4a", :size 2, :type "audio" :alias "vaca voice"}
                           {:url "/raw/audio/english/l1/a1/vera.mp3", :size 2, :type "audio" :alias "vera voice"}
                           {:url "/raw/audio/english/l1/a1/mari_ending.m4a", :size 2, :type "audio" :alias "mari ending"}
                           {:url "/raw/audio/ferris-wheel/fw-try-again.mp3", :size 2, :type "audio" :alias "try again"}],
           :objects       {:background     {:type "background", :src "/raw/img/casa/background.jpg"},
                           ...
                           :common-pointer {:type   "transparent"
                                            :x      300 :y 300
           ...
           :actions       {:senora-vaca-audio-1                {:type        "animation-sequence",
                                                                ...
                                                                :duration    3.24
                                                                :phrase      :intro
                                                                :phrase-text "We are going to learn some new words."}
                           ...
                           :senora-vaca-audio-2                {:type        "animation-sequence",
                                                                ...
                                                                :phrase-text "Look at this! What could be inside the boxes?
                                                                    Let’s look inside them! Touch the first box to see what’s inside."}
                           ...
                           :senora-vaca-audio-touch-second-box {:type        "animation-sequence",
                                                                ...
                                                                :phrase-text "Very good! Let’s look inside the second box.
                                                                    Touch the next box to see what’s inside."}
                           ...
                           :senora-vaca-audio-touch-third-box  {:type        "animation-sequence",
                                                                ...
                                                                :phrase-text "Good job! Now we will look inside the third box.
                                                                    Touch the last box to see what’s inside."}
                           ...
                           :vaca-goodbye-var                   {:type        "action"
                                                                ...
                                                                :phrase-text "Goodbye %concept%! Goodbye!"}
                           ...
                           :concept-intro                      {:type        "sequence"
                                                                ...
                                                                :phrase-text "This is a %concept%! Can you say %concept%? (pause) %concept%. (together) %concept%!"}
                           ...
                           :concept-chant                      {:type        "sequence"
                                                                ...
                                                                :phrase-text "Vaca: Good! Let’s say it 3 times, like this: %concept%, %concept%, %concept%!
                                               Vera: %concept%, %concept%, %concept%
                                               Vaca: Once more!
                                               Vera: %concept%, %concept%, %concept%"}
                           ...
                           :mari-finish                        {:type        "sequence-data",
                                                                ...
                                                                :phrase-text "Great job little genius! Do you want to see what’s inside the boxes again?
                                                                    Touch Senora Vaca to look inside again.
                                                                    Otherwise, touch the door to go to the park for your next activity"}
                           ...
                           :set-reminder-on                    {:type     "set-interval"
                                                                :id       "reminder"
                                                                :interval 17000
