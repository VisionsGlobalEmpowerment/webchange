(ns webchange.editor-v2.graph-builder.graph.phrases-graph--hide-n-seek-source)
...
(def data {:assets        [{:url    "/raw/img/park/hide-n-seek/background.jpg",
                           ...
                           {:url    "/raw/img/park/hide-n-seek/front-objects.png",
                            ...
                            :height 1080,
                            :alias  nil}
                           {:url "/raw/audio/l1/assessment1/Mari_Level1_Assessment1.m4a", :size 5, :type "audio" :alias "mari voice"}
                           {:url "/raw/audio/l1/assessment1/Assessment1_GameVoice_Set1.m4a", :size 5, :type "audio" :alias "words"}
