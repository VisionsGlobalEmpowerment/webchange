(ns webchange.editor-v2.graph-builder.graph.data.book.source)

(def data {:assets        [{:url "/raw/img/library/book/background.jpg", :size 10, :type "image"}
                           ...
                           {:url "/raw/audio/l1/a6/L1_A6_Lion_words.m4a", :size 2, :type "audio" :alias "librarian books words" :target "lion"}
           ...
           :objects       {:background      {:type   "background", :src "/raw/img/library/book/background2.jpg"
                           ...
                           :book            {:type       "animation" :x 928 :y 1048 :name "book" :anim "close_idle" :speed 0.3
                                             :scene-name "book" :anim-offset {:x 0 :y -480}
                                             :width      1439 :height 960 :scale-x 1 :scale-y 1 :start false}

                           :title-text      {:type         "text" :x 929 :y 164 :width 680 :height 800
                           ...
                           :content         {:type       "transparent" :x 209 :y 89 :children ["letter" "image" "image2" "image3"]
                                             :transition "content"
                                             :states     {:visible {:type "group" :opacity 0} :hidden {:type "transparent"}}}

                           :letter          {:type         "text" :x 220 :y 150 :width 200 :height 200
                                             :font-family  "Comic Sans MS" :font-size 180
                                             :shadow-color "#1a1a1a" :shadow-offset {:x 5 :y 5} :shadow-blur 5 :shadow-opacity 0.5
                                             :states       {:default {}}}

                           :image           {:type       "image" :x 220 :y 570 :width 100 :height 100 :scale-x 2 :scale-y 2 :states {:default {}}
                                             :transition "image"}

                           :image2          {:type       "image" :x 980 :y 150 :width 100 :height 100 :scale-x 2 :scale-y 2 :states {:default {}}
                                             :transition "image2"}

                           :image3          {:type       "image" :x 980 :y 570 :width 100 :height 100 :scale-x 2 :scale-y 2 :states {:default {}}
                                             :transition "image3"}

                           :next-page-arrow {:type    "transparent" :x 1444 :y 91 :width 200 :height 200
           ...
           :actions       {:start-scene               {:type "sequence"
                           ...
                           :set-content-ardilla       {:type "parallel"
                           ...
                           :set-content-iman          {:type "parallel"
                           ...
                           :open-next-page            {:type "sequence-data"
                           ...
                           :read-page                 {:type "parallel"
                                                       :data [{:type "sequence-data"
                                                              ...
                                                              {:type "action" :id "read-page-current-concept"}]}

                           :read-page-current-concept {:type               "action" :from-var [{:var-name "current-word" :var-property "book-read-action"}]
                                                       :phrase             :read-page
                           ...
                           :read-title                {:type               "sequence-data"
                                                       :data               [{:type        "audio",
                                                                            ...
                                                                            {:type        "text-animation",
                                                                             ...
                                                                             :animation   "bounce",
                                                                             :target      "title-text",
                                                                             :data        [{:start 20.241, :end 20.294, :duration 0.053, :at 20.241, :chunk 0}
                                                                            ...
                                                                            {:type        "text-animation",
                                                                             ...
                                                                             :animation   "bounce",
                                                                             :target      "title-text",
                                                                             :data        [{:start 24.694, :end 24.734, :duration 0.04, :at 24.694, :chunk 0}
