(ns webchange.editor-v2.graph-builder.graph.data.pinata.dialog--correct)

(def data {:parent               {:connections #{{:previous :root
                                                  :name     "next"
                                                  :handler  :mari-audio-correct-2} {:previous :root
                                                                                    :name     "next"
                                                                                    :handler  :mari-audio-correct-1} {:previous :root
                                                                                                                      :name     "next"
                                                                                                                      :handler  :mari-audio-correct-5} {:previous :root
                                                                                                                                                        :name     "next"
                                                                                                                                                        :handler  :mari-audio-correct-4} {:previous :root
                                                                                                                                                                                          :name     "next"
