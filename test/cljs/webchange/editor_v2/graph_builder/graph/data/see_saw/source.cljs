(ns webchange.editor-v2.graph-builder.graph.data.see-saw.source)

(def data {:assets        [{:url "/raw/audio/english/l1/a2/mari.m4a", :size 2, :type "audio", :alias "mari", :target "mari"}
                           {:url "/raw/audio/l1/a2/Mari_Level1_Activity2.m4a", :size 2, :type "audio", :alias "mari 2", :target "mari"}
                           {:url "/raw/audio/english/l1/a2/mari_ending.m4a", :size 2, :type "audio", :alias "mari ending", :target "mari"}
                           {:url "/raw/audio/english/l1/game_voice.m4a", :size 5, :type "audio" :alias "game voice", :target "game-voice"}
                           {:url "/raw/audio/l1/a2/L1_A2_GameVoice_Object_1_List.m4a", :size 2, :type "audio", :alias "game voice 1", :target "game-voice"}
                           {:url "/raw/audio/l1/a2/L1_A2_GameVoice_Object_2_List.m4a", :size 2, :type "audio", :alias "game voice 2", :target "game-voice"}
                           {:url "/raw/audio/l1/a2/L1_A2_GameVoice_Object_3_List.m4a", :size 2, :type "audio", :alias "game voice 3", :target "game-voice"}
           ...
           :actions       {:mari-welcome-audio         {:type                          "animation-sequence",
                                                        ...
                                                        :phrase-description-translated "Welcome speech"
                                                        :phrase-text                   "Bienvenido al parque mi amigo! Vamos a repasar unas palabras mientras juegas en el sube y baja."
                                                        :phrase-text-translated        "Welcome to the park my friend! Let’s review some words while playing on the see saw."}
                           ...
                           :mari-move-to-start         {:type                          "parallel"
                                                        :data                          [{:type "sequence-data"
                                                                                        ...
                                                                                        {:type                   "animation-sequence",
                                                                                         ...
                                                                                         :phrase-text-translated "Coloca esta foto sobre el sube y baja para empezar el juego!"}]
                                                        :phrase                        :move-to-start
                                                        :phrase-description            "Mover imagen para comenzar"
                                                        :phrase-description-translated "Move picture to start"}
                           ...
                           :introduce-concept          {:type                          "sequence"
                                                        ...
                                                        :phrase-description-translated "Concept, concept, concept!"}
                           ...
                           :try-another                {:type                          "animation-sequence",
                                                        ...
                                                        :phrase-description-translated "Try next picture"
                                                        :phrase-text                   "Wiiiiiiiii! Te estas divirtiendo? Hay que intentar otra foto."
                                                        :phrase-text-translated        "Yippee! Are you having fun? Let’s try another picture."}
                           ...
                           :mari-finish                {:type                          "sequence-data",
                                                        :data                          [{:type          "transition",
                                                                                        ...
                                                                                        {:type                   "animation-sequence",
                                                                                         ...
                                                                                         :start                  0.907,
                                                                                         :duration               15.819
                                                                                         :phrase-text            "Felicidades! Nos ayudaste a poner todas las fotos sobre el sube y baja! Puedes jugar este juego de nuevo, or haz clic en esta flecha para empezar el proximo juego."
                                                                                         :phrase-text-translated "Congratulations! You helped all of the pictures ride on the see-saw! You can play this game again, or, hit this arrow to start your next game."}]
                                                        :phrase                        :finish
