...
(deftest next-for-test
  []
  (is (= {:activity "swings", :time-expected 300, :level 1, :lesson 1}
          (activity/next-for [] levels {:activity "home", :time-expected 300, :level 1, :lesson 1}))))

(deftest next-for-test-only-match
  []
  (is (= {:only ["beginner"], :activity "see-saw", :time-expected 300, :level 1, :lesson 1}
         (activity/next-for [tags/beginner] levels {:activity "home", :time-expected 300, :level 1, :lesson 1}))))